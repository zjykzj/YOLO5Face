...
Usage - Predict Plates using Pytorch:
    $ python3 detect_face_and_landmarks.py --weights shufflev2_face-i800-e300.pt --source ./assets/widerface/

Usage - Predict Plates using ONNXRuntime:
    $ python3 detect_face_and_landmarks.py --weights shufflev2_face-i800-e300.onnx --source ./assets/widerface/
